...
public class PaiementFactureFournisseur extends javax.swing.JFrame {
...
public PaiementFactureFournisseur(int idFacture) {
        initComponents();
        idFactureSelected = idFacture;
        try {
            populateForm(idFacture);
        } catch (ParseException ex) {
            Logger.getLogger(PaiementFactureFournisseur.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    public PaiementFactureFournisseur() {
        initComponents();
    }
    ...
    public void initEvent(ModalActionEvent event, int row) {
        ...
        public void actionPerformed(ActionEvent ae) {
            ...
            PaiementFournisseurDAO paieDAO = DAOFactory.getPaiementFournisseurDAO();
            PaiementFournisseur paie = new PaiementFournisseur();
            
            paie.setMontantRecu(Float.parseFloat(montantVerse.getValue().toString()));
            paie.setIdFactureFournisseur(idFactureSelected);
            paie.setIdFournisseur(Integer.parseInt(idClient.getText()));
            ...
            paie.setDatePaiement(formattedDate);
                ...
                if(paieDAO.create(paie)){
                    ...
                    SortieCaisseDAO ecDAO = DAOFactory.getSortieCaisseDAO();
                    SortieCaisse sortie = new SortieCaisse();
                    sortie.setIdSourceReference(paieDAO.getGeneratedKey());
                    sortie.setMontant(Float.parseFloat(montantVerse.getValue().toString()));
                    sortie.setDateSortie(formattedDate);
                    sortie.setDescription("Paiement de la facture fournisseur n°"+idFactureSelected+" d'une somme de "+ montantVerse.getValue().toString());
                    ecDAO.create(sortie);
    ...
    private void populateForm( int idFac) throws ParseException {
        ...
        FactureFournisseurDAO facDAO = DAOFactory.getFactureFournisseurDAO();
        FactureFournisseur fac =  facDAO.find(idFac);
        refFacture.setText(fac.getRefFacture());
        idFacture.setText(String.valueOf( fac.getId() ));
        reste = DAOFactory.getPaiementFournisseurDAO().getMontantVerse(idFac);
        
        FormatUtils formater = new FormatUtils();
        resteAPayer.setText(formater.formatFloat(fac.getMontant() - reste ));
        montantAPayer.setText(formater.formatFloat(fac.getMontant()));
        idClient.setText(String.valueOf( fac.getIdFournisseur()) );
        datePaiement.setDate(new SimpleDateFormat("yyyy-MM-dd HH:mm:ss").parse(fac.getDateFacture()));
        nomClient.setText(fac.getFournisseur().getNom() + " " + fac.getFournisseur().getPrenom());
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PaiementFactureFournisseur.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new PaiementFactureFournisseur().setVisible(true);
            }
        });
    }
