...
menuList1.addItem(new MenuModel("commande", "Vente", MenuModel.MenuType.MENU));
menuList1.addItem(new MenuModel("compte", "Client", MenuModel.MenuType.MENU));
menuList1.addItem(new MenuModel("panier", "Achat", MenuModel.MenuType.MENU));
menuList1.addItem(new MenuModel("compte", "Fournisseur", MenuModel.MenuType.MENU));
...
menuList1.addItem(new MenuModel("parametre", "Paramètres",MenuModel.MenuType.MENU));
    ...
    private void initComponents() {
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addComponent(jLabel1)
                .addGap(32, 32, 32)
                .addComponent(menuList1, javax.swing.GroupLayout.PREFERRED_SIZE, 482, javax.swing.GroupLayout.PREFERRED_SIZE)
