...
private void init(){
menuList1.addItem(new MenuModel("hamburger","Acceuil",MenuModel.MenuType.MENU));
menuList1.addItem(new MenuModel("caisse","Caisse",MenuModel.MenuType.MENU));
menuList1.addItem(new MenuModel("magasin", "Vente", MenuModel.MenuType.MENU));
    menuList1.addItem(new MenuModel("magasin", "Client", MenuModel.MenuType.MENU));
...
menuList1.addItem(new MenuModel("magasin", "Magasin", MenuModel.MenuType.MENU));
menuList1.addItem(new MenuModel("compte", "Compte",MenuModel.MenuType.MENU));
menuList1.addItem(new MenuModel("groupe", "Groupe",MenuModel.MenuType.MENU));//logout1
    ...
    private void initComponents() {
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addComponent(jLabel1)
                .addGap(32, 32, 32)
                .addComponent(menuList1, javax.swing.GroupLayout.PREFERRED_SIZE, 356, javax.swing.GroupLayout.PREFERRED_SIZE)
