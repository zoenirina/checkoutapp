...
public class InvoiceF {
    ...
    public InvoiceF() {
        ...
        public static void printPDF( FactureFournisseur fac, CommandeF comm,  Reception recep ) {
            
        FormatUtils formater = new FormatUtils();
        Personne fournis = comm.getFournisseur();
...
//            BaseColor boldBlue = new BaseColor(48,4,114);
            ...
            clientCell.addElement(new Phrase("Fournisseur", boldBlue));
            ...
            invoiceInfoCell3.addElement(new Phrase(DateConverter.convertToDate(recep.getDateReception()))); 
...
//                    " \n\nDate de livraison: "+DateConverter.convertToDate(recep.getDateLivraison())
//                    )); // info sur client
...
//            headerTable.addCell(invoiceInfoCell);
            ...
            List<ReceptionDetail> recepDet = recep.getReceptionDetails();
            for (int i = 0; i < recepDet.size(); i++) {
            float tva = recepDet.get(i).getProduit().getTVA();
            int qte = recepDet.get(i).getQuantiteRecu();
            ...
            String[] values = {
                ...
                formater.formatFloat(ttTTC+recep.getFrais())
            };
