...
import javaap.modal.ModalBonReception;
import javaap.modal.ModalFactureFournisseur;
import javaapp.PrinterPDF.BCFournisseur;
...
private final int borderRadius = 10;
    ...
    private javaapp.bean.CommandeF commandeSelected = null;
    private ModalBonReception modal = null;
    private javaapp.bean.Reception recepSelected = null;
    private javaapp.bean.Facture  facSelected = null;
    private CommandeFournisseurDAO commandeDAO ;
    private final ReceptionDAO recepDAO;
    private final FactureDAO facDAO;
    private ProduitDAO produitDAO;
    private CommandeDetailFournisseurDAO commDetDAO;
    private CommandeDetailFournisseurDAOImpl cmdDAO;
    ...
    public Commande(JPanel panel) {
        ...
        cmdDAO = DAOFactory.getCommandeDetailFournisseurDAOImpl();
        init();
    }
    ...
    public void init(){
        ...
        commDetDAO = DAOFactory.getCommandeDetailFournisseurDAO();
        produitDAO = DAOFactory.getProduitDAO();
        cmdDAO = DAOFactory.getCommandeDetailFournisseurDAOImpl();
...
//        filterData(1);
    ...
    private void initComponents() {
        ...
        date1.setFont(new java.awt.Font("Verdana", 0, 13)); // NOI18N
        ...
        date2.setFont(new java.awt.Font("Verdana", 0, 13)); // NOI18N
        ...
        btnConvertBL.setText("Convertir en bon de reception");
        ...
        jLabel8.setText("Information général");
        ...
        btn_valider.setText("Confirmer l'achat");
        ...
        dateCommande.setFont(new java.awt.Font("Verdana", 0, 13)); // NOI18N
        ...
        vendeur.setFont(new java.awt.Font("Verdana", 0, 13)); // NOI18N
        vendeur.setForeground(new java.awt.Color(51, 51, 51));

        refCommandeField.setFont(new java.awt.Font("Verdana", 0, 13)); // NOI18N
        ...
        btn_recu.setForeground(new java.awt.Color(43, 40, 54));
        btn_recu.setText("Accusé de réception");
        ...
        jPanel7Layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel7Layout.createSequentialGroup()
                ...
                .addGroup(jPanel7Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    ...
                    .addComponent(dateFacture, javax.swing.GroupLayout.DEFAULT_SIZE, 500, Short.MAX_VALUE))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                .addGroup(jPanel7Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
        ...
        idReception.setForeground(new java.awt.Color(204, 255, 255));
        ...
        jPanel17Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel17Layout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(idReception, javax.swing.GroupLayout.PREFERRED_SIZE, 101, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        jPanel17Layout.setVerticalGroup(
            ...
            .addGroup(jPanel17Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                ...
                .addComponent(idReception, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
        );
        ...
        jPanel8Layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel8Layout.createSequentialGroup()
                ...
                .addGroup(jPanel8Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    ...
                    .addComponent(dateLivraison, javax.swing.GroupLayout.DEFAULT_SIZE, 500, Short.MAX_VALUE))
                .addGroup(jPanel8Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel8Layout.createSequentialGroup()
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
        ...
        btn_classer_facture.setColorOver(new java.awt.Color(246, 250, 246));
        ...
        page2Layout.setHorizontalGroup(
            ...
            .addGroup(page2Layout.createSequentialGroup()
                ...
                .addGroup(page2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                    ...
                    .addComponent(jPanel15, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, 970, Short.MAX_VALUE)
                    .addComponent(jPanel4, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                    .addComponent(factureSection)
                    .addComponent(livraisonSection)
                    .addGroup(javax.swing.GroupLayout.Alignment.LEADING, page2Layout.createSequentialGroup()
                        .addComponent(btn_recu, javax.swing.GroupLayout.PREFERRED_SIZE, 181, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                        ...
                        .addGap(35, 35, 35)
                        .addComponent(btn_valider, javax.swing.GroupLayout.PREFERRED_SIZE, 179, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(18, 18, 18)
        ...
        page2Layout.setVerticalGroup(
            ...
            .addGroup(page2Layout.createSequentialGroup()
                ...
                .addGroup(page2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(idCommande, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                    .addComponent(jLabel5))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
...
private void updateCommandeSelected(){
    int selectedRow = tableOutput.getSelectedRow();
        if (selectedRow != -1) {
            ...
            //récuperer les information sur la commande
            ...
            id_client.setText(""+commandeSelected.getFournisseur().getId());
            ...
            recepSelected = recepDAO.findByCommande(commandeSelected.getId());

            if (recepSelected != null && recepSelected.getId() != 0){
                idReception.setText(String.valueOf(recepSelected.getId()));
                refLivraison.setText(recepSelected.getRefReception());
                try {
//                    dateLivraison.setDate(new SimpleDateFormat("yyyy-MM-dd HH:mm:ss").parse(recepSelected.getDateLivraison()));
            ...
            //recupérer les détails de la facture
                facSelected =facDAO.findBy(recepSelected.getId());
                if(facSelected != null && facSelected.getId() != 0){
                    ...
                    try {
                        if(!recepSelected.getDateReception().isEmpty())dateFacture.setDate(new SimpleDateFormat("yyyy-MM-dd HH:mm:ss").parse(facSelected.getDateFacture()));
                    } catch (ParseException ex) {
                        Logger.getLogger(Commande.class.getName()).log(Level.SEVERE, null, ex);
                    }
                }
...
String[] column = {"Article", "Réf", "PU HT", "TVA", "Remise", "Qté comm.", "Qté réçue", "Reste à recevoir", "Total TTC"};
DefaultTableModel model = new DefaultTableModel(null, column);

// Préparation des données pour la table
Object[] data = new Object[9];
//List<CommandeDetailFournisseur> cmd = DAOFactory.getCommandeDetailFournisseurDAOImpl().selectAll(commandeSelected.getId());

for (CommandeDetailFournisseur commandeDet : commDetDAO.select(commandeSelected.getId())) {
    float tva = commandeDet.getProduit().getTVA();
    int qte = commandeDet.getQuantite();
    float PUHT = commandeDet.getProduit().getPUHT();
    float remise = commandeDet.getRemise();
    ...
    CommandeDetailFournisseur comm2 = cmdDAO.findById(commandeDet.getId());
    data[6] = comm2.getQuantiteRecue();
    data[7] = comm2.getQuantiteRestante();
    data[8] = formater.formatFloat(Calculator.getTotalTTC(PUHT, remise, tva, qte));

    model.addRow(data);
}
// Mise à jour du modèle de la table
...
private void updateButtonVisibility() {
    ...
    if (commandeSelected.getStatus() == null) {
        ...
        switch (commandeSelected.getStatus()) {
            ...
            case "Réçu":
            case "Réçue":
                btn_recu.setText("Classer en attente");
                break;
            case "En attente":
...
//        afficherBoutton(false);
    ...
    if (row != -1) {
        ...
        JPanel dialog = new JPanel(new GridLayout(9, 2));
        ...
        JSpinner qteCommField = new JSpinner(new SpinnerNumberModel(Integer.parseInt(model.getValueAt(row, 5).toString()), 0, 1000, 1));
        JSpinner qteLivreField = new JSpinner(new SpinnerNumberModel(Integer.parseInt(model.getValueAt(row, 6).toString()), 0, 1000, 1));
        JSpinner qteRestanteField = new JSpinner(new SpinnerNumberModel(Integer.parseInt(model.getValueAt(row, 7).toString()), 0, 1000, 1));
        
        puhtField.setEditable(false);
        refField.setEditable(false);
        qteRestanteField.setEnabled(false); // Qté restante est calculée, donc non éditable
        ...
        dialog.add(new JLabel("Qté commandée"));
        dialog.add(qteCommField);
        dialog.add(new JLabel("Qté livrée"));
        dialog.add(qteLivreField);
        dialog.add(new JLabel("Reste à livrer"));
        dialog.add(qteRestanteField);
        ...
        if (result == JOptionPane.OK_OPTION) {
            ...
            model.setValueAt(Integer.parseInt(qteCommField.getValue().toString()), row, 5);
            model.setValueAt(Integer.parseInt(qteLivreField.getValue().toString()), row, 6);
            ...
            int qteComm = Integer.parseInt(qteCommField.getValue().toString());
            int qteLivre = Integer.parseInt(qteLivreField.getValue().toString());
            int qteRestante = qteComm - qteLivre;

            model.setValueAt(qteRestante, row, 7); // Mettre à jour la Qté restante
            model.setValueAt(formater.formatFloat(puHT * qteComm), row, 8); // Mettre à jour le Total TTC

            CommandeDetailFournisseur commDetSelected = commDetDAO.findByCommandeProduit(commandeSelected.getId(), refField.getText());
            commDetSelected.setQuantite(qteComm);
            commDetSelected.setRemise(remise);
            ...
            if (commDetDAO.update(commDetSelected)) {
                ...
                Toast t = new Toast("Ligne modifiée!", pan.getLocationOnScreen().x + pan.getWidth() - 320, pan.getLocationOnScreen().y + 7);
                t.showtoast();
    ...
    private void btn_delete_invoice_itemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_delete_invoice_itemActionPerformed
        ...
        if (selectedRow != -1) {
            ...
            if(JOptionPane.showConfirmDialog(null, "Etes-vous sûr de vouloir supprimer cette ligne, cette action est irreversible?","Confirmation de suppression",JOptionPane.YES_NO_OPTION) == 0){
                CommandeDetailFournisseurDAO commDet = DAOFactory.getCommandeDetailFournisseurDAO();
            
            if(commDet.delete(commandeDAO.find(refCommandeField.getText()).getId(), produitDAO.find(refProduitSelected).getId())){
                updateTotals(); 
                commandeSelected.setMontant(formater.parseFloat(totalNetAPayerField.getText()));
                commandeDAO.update(commandeSelected);
    ...
    private void btnConvertBLActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnConvertBLActionPerformed
        modal = new ModalBonReception(Integer.parseInt(idCommande.getText()));
    ...
    private void btn_creer_factureActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_creer_factureActionPerformed
        if (recepSelected != null && recepSelected.getId() != 0){
            if(facSelected == null || facSelected.getId() == 0){
                ModalFactureFournisseur modal = new ModalFactureFournisseur(Integer.parseInt(idReception.getText()));
                modal.setVisible(true); 
            }else{}
        }else{
        JOptionPane.showMessageDialog(null, "La commande n°"+recepSelected.getIdCommande()+" ne possède aucun bon de livraison.\nVeuillez en créer préalablement", "Erreur", JOptionPane.ERROR_MESSAGE);
        }
    ...
    private void btn_validerActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_validerActionPerformed
        ...
        if("Brouillon".equals(commandeSelected.getStatus())){
                ...
                if(JOptionPane.showConfirmDialog(null, "Etes-vous sûr de vouloir clôturer cette commande?\n\nUne fois marquée 'Clôturée', une commande est non modifiable.\nAssurez-vous d'avoir vérifié correctement la commande","Validation de la commande n°"+commandeSelected.getId(),JOptionPane.YES_NO_OPTION) == 0){
                    commandeSelected.setStatus("Cloturée");
                    if(commandeDAO.update(commandeSelected)){
    ...
    if(JOptionPane.showConfirmDialog(null, "Etes-vous sûr de vouloir valider cette commande?","Confirmation validation",JOptionPane.YES_NO_OPTION) == 0){
        ...
        BCFournisseur.printPDF(pan, commandeSelected);
    }
...
//            commandeSelected.setDateFinValidite(new SimpleDateFormat("yyyy-MM-dd").format(dateFinValidite.getDate()));
            if(commandeDAO.update(commandeSelected)){
                t = new Toast("Création de la facture réussie!", pan.getLocationOnScreen().x+pan.getWidth()-320, pan.getLocationOnScreen().y+7);
                t.showtoast();
            }
...
//            JOptionPane.showMessageDialog(null, "Commande validée!","Confirmation",JOptionPane.INFORMATION_MESSAGE);
    ...
    private void btn_recuActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_recuActionPerformed
        if ( !"Reçu".equals(commandeSelected.getStatus()) ){
        if(JOptionPane.showConfirmDialog(null, "Etes-vous sûr de vouloir accusé cette commande de réception?","Confirmation d'annulation",JOptionPane.YES_NO_OPTION) == 0){
            commandeSelected.setStatus("Réçu");
            if(commandeDAO.update(commandeSelected)){
                t = new Toast("Commande accusé de réception!", pan.getLocationOnScreen().x+pan.getWidth()-320, pan.getLocationOnScreen().y+7);
                t.showtoast();
                updateButtonVisibility();
            }
        }
            ...
            if(commandeDAO.update(commandeSelected)){
                t = new Toast("Commande mise en attente!", pan.getLocationOnScreen().x+pan.getWidth()-320, pan.getLocationOnScreen().y+7);
                t.showtoast();
                updateButtonVisibility();
            }
            }
    ...
    private void btn_add_invoice_itemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_add_invoice_itemActionPerformed
        ...
        dialog.add(new JLabel("Réference article"));
        
        JComboBox<String> produittComboBox = new JComboBox<>();
        
        for (javaapp.bean.Produit p : produitDAO.select()) {
            produittComboBox.addItem(p.getRefProduit());
        }
        produittComboBox.setSelectedIndex(0);
        
        dialog.add(produittComboBox);
        dialog.add(new JLabel("Remise"));
        dialog.add(remiseField);
        ...
        int result = JOptionPane.showConfirmDialog(frame, dialog, "Ajouter une ligne", JOptionPane.OK_CANCEL_OPTION, JOptionPane.PLAIN_MESSAGE);
            if (result == JOptionPane.OK_OPTION) {
                Produit produit = produitDAO.find(produittComboBox.getSelectedItem().toString());
                ...
                CommandeDetailFournisseur commDet = new CommandeDetailFournisseur();
                commDet.setIdCommande(commandeSelected.getId());
                commDet.setIdProduit(produit.getId());
                commDet.setProduit(produit);
                commDet.setQuantite(Integer.parseInt(qteField.getValue().toString()));
                commDet.setRemise(Float.parseFloat(remiseField.getValue().toString()));
            ...
            Object[] newRow = {
                ...
                produittComboBox.getSelectedItem().toString(),
    ...
    private void btn_annuler_commandeActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_annuler_commandeActionPerformed
        ...
        if(JOptionPane.showConfirmDialog(null, "Etes-vous sûr de vouloir annuler la commande?","Message de confirmation",JOptionPane.YES_NO_OPTION) == 0){
         ...
         if(JOptionPane.showConfirmDialog(null, "Etes-vous sûr de vouloir mettre la commande 'En attente' ?","Message de confirmation",JOptionPane.YES_NO_OPTION) == 0){
            commandeSelected.setStatus("En attente");
            if(commandeDAO.update(commandeSelected)){
                t = new Toast("Commande en attente!", pan.getLocationOnScreen().x+pan.getWidth()-320, pan.getLocationOnScreen().y+7);
                t.showtoast();
            }
        }    
        }
    ...
    public void refreshTable(List<javaapp.bean.CommandeF> commandes){
        String[] column = {"Référence", "Date commande","Fournisseur", "Montant TTC","Date prévue", "Facturé", "Status"};
        Object[] data = new Object[7];
        DefaultTableModel model = new DefaultTableModel(null, column);
        
        for(javaapp.bean.CommandeF commande : commandes){
             data[0]=commande.getRefCommande();
             data[1]=DateConverter.convertToLetter(commande.getDateCommande());
             data[2]=commande.getFournisseur().getNom()+" "+commande.getFournisseur().getPrenom();
             data[3]=formater.formatFloat(commande.getMontant());
             javaapp.bean.Reception recep = recepDAO.findByCommande(commande.getId());
             data[4]=( recep != null && recep.getId() != 0) ? DateConverter.convertToLetter(recep.getDateReception()) : "- ";
