...
//                btn_creer_facture.setVisible(false);
    ...
    private void initComponents() {
        ...
        page1.add(btn_refresh, new org.netbeans.lib.awtextra.AbsoluteConstraints(900, 90, 37, 37));
        ...
        page1.add(scrollTable, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 140, 910, 610));
        ...
        page1.add(nomClientKeySearch, new org.netbeans.lib.awtextra.AbsoluteConstraints(560, 90, 270, 37));

        menu5.setFont(new java.awt.Font("Verdana", 1, 13)); // NOI18N
        menu5.setForeground(new java.awt.Color(51, 51, 51));
        menu5.setText("Mot clé");
        page1.add(menu5, new org.netbeans.lib.awtextra.AbsoluteConstraints(560, 70, -1, -1));
        ...
        page1.add(btn_search1, new org.netbeans.lib.awtextra.AbsoluteConstraints(850, 90, 37, 37));
        ...
        page1.add(panelBorderRound1, new org.netbeans.lib.awtextra.AbsoluteConstraints(790, 20, 150, 40));
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                .addGap(32, 32, 32)
                .addComponent(page1, javax.swing.GroupLayout.PREFERRED_SIZE, 1013, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
        );
...
refreshTable(paieDAO.filter(nomClientKeySearch.getText()));
    ...
    public void refreshTable(List<PaiementFournisseur> paiements){
    String[] column = {"Réference", "Date paiement","Fournisseur", "Facture","Total TTC","Montant réçu",  "Total versé"};
    Object[] data = new Object[7];
    DefaultTableModel model = new DefaultTableModel(null, column);
   
       for(PaiementFournisseur paie : paiements){
            data[0] = paie.getRefPaiement();
            data[1] = paie.getDatePaiement();
            data[2] = paie.getFournisseur().getNom()+" "+paie.getFournisseur().getPrenom();
            data[3] = paie.getFactureFournisseur().getRefFacture();
//            data[4] = formater.formatFloat(paie.getFacture().getMontant());
            data[4]= formater.formatFloat(paie.getFactureFournisseur().getMontant());
            data[5]= formater.formatFloat(paie.getMontantRecu());
//            data[6]= formater.formatFloat(paie.getFactureFournisseur().getMontant() - DAOFactory.getPaiementDAO().getMontantVerse(paie.getIdFactureFournisseur()));
            data[6]= formater.formatFloat(paieDAO.getMontantVerse(paie.getIdFactureFournisseur()));
            model.addRow(data);
        }
