...
public class Client extends javax.swing.JPanel {
    ...
    private javaapp.bean.Personne clientSelected;
    ...
    private void initComponents() {
        ...
        setPreferredSize(new java.awt.Dimension(1004, 1100));
        ...
        listPanelLayout.setVerticalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, listPanelLayout.createSequentialGroup()
                .addGap(20, 20, 20)
                .addGroup(listPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(panelBorderRound2, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        jLabel4.setText("Information générale sur un client");
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                .addGap(23, 23, 23)
                .addComponent(listPanel, javax.swing.GroupLayout.PREFERRED_SIZE, 1045, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
            .addGroup(layout.createSequentialGroup()
    ...
    private void btnsaveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnsaveActionPerformed
        ...
        javaapp.bean.Personne client = new javaapp.bean.Personne();

        switch (btnSaveState) {
            case "insert":
                // Insertion de nouvelles données client
                client = new javaapp.bean.Personne(0, nom.getText(), prenom.getText(), email1.getText(), email2.getText(), tel1.getText(), tel2.getText(), tel3.getText(), adresse.getText(), nif.getText(), stat.getText(), null) ;
            ...
            case "update":
                ...
                client = new javaapp.bean.Personne(clientSelected.getId(), nom.getText(), prenom.getText(), email1.getText(), email2.getText(), tel1.getText(), tel2.getText(), tel3.getText(), adresse.getText(), nif.getText(), stat.getText(), null) ;
    ...
    private void btndeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btndeleteActionPerformed
        ...
        if (confirm == JOptionPane.YES_OPTION) {
            if(clientDAO.delete(clientSelected))refreshTable( clientDAO.select() );
        }
    ...
    private void btn_searchActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_searchActionPerformed
        try {
            refreshTable( clientDAO.filter(client_key_search.getText()) );
  ...
  public void rowcount(){
    nombre_ligne.setText("Clients ("+ table.getRowCount()+")");
    }
  
    private void refreshTable( List < javaapp.bean.Personne > clients ){
