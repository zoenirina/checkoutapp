...
public class Fournisseur extends javax.swing.JPanel {
    ...
    private int selectedFournisseurId = 0;
    public String btnSaveState;
    private javaapp.bean.Personne fournisseurSelected;
    ...
    public Fournisseur(UserType usertype1) {
        initComponents();
    ...
    private void init(){
        ...
        refreshTable( fournisseurDAO.select() );
    ...
    private void initComponents() {
                ...
                .addGroup(listPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(listPanelLayout.createSequentialGroup()
                        .addGroup(listPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, listPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, listPanelLayout.createSequentialGroup()
                ...
                .addGroup(listPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(listPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                        .addComponent(btn_refresh, javax.swing.GroupLayout.PREFERRED_SIZE, 40, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addComponent(btn_search, javax.swing.GroupLayout.PREFERRED_SIZE, 40, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addComponent(client_key_search, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 40, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                .addComponent(scrollTable, javax.swing.GroupLayout.PREFERRED_SIZE, 536, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        jLabel4.setText("Information générale sur un fournisseur");
        ...
        nif.setFont(new java.awt.Font("Verdana", 0, 13)); // NOI18N
        ...
        jLabel16.setText("Information personnelle");
        ...
        email2.setFont(new java.awt.Font("Verdana", 0, 13)); // NOI18N
        ...
        stat.setFont(new java.awt.Font("Verdana", 0, 13)); // NOI18N
        ...
        adresse.setFont(new java.awt.Font("Verdana", 0, 13)); // NOI18N
    ...
    private void tableMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tableMouseClicked
       // Masquer le panneau de liste et afficher le panneau de formulaire
        ...
        if (rowIndex != -1) {
//            PersonneDAO fournisseurDAO = fournisseurDAO;
            selectedFournisseurId = Integer.parseInt(model.getValueAt(rowIndex, 0).toString());
            fournisseurSelected  = fournisseurDAO.find(selectedFournisseurId);

            // Affichage des des informations sur le client selectionné
            nom.setText(fournisseurSelected.getNom());
            prenom.setText(fournisseurSelected.getPrenom());
            email1.setText(fournisseurSelected.getEmail1());
            email2.setText(fournisseurSelected.getEmail2());
            tel1.setText(fournisseurSelected.getTel1());
            tel2.setText(fournisseurSelected.getTel2());
            tel3.setText(fournisseurSelected.getTel3());
            adresse.setText(fournisseurSelected.getAdresse());
            nif.setText(fournisseurSelected.getNIF());
            stat.setText(fournisseurSelected.getStat());
        }
    ...
    private void btnsaveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnsaveActionPerformed
        ...
        javaapp.bean.Personne fournisseur = new javaapp.bean.Personne();

        switch (btnSaveState) {
            case "insert":
                // Insertion de nouvelles données client
                fournisseur = new javaapp.bean.Personne(0, nom.getText(), prenom.getText(), email1.getText(), email2.getText(), tel1.getText(), tel2.getText(), tel3.getText(), adresse.getText(), nif.getText(), stat.getText(), null) ;
                    fournisseurDAO.create(fournisseur);//créer le nouveau client 
            ...
            case "update":
                ...
                fournisseur = new javaapp.bean.Personne(fournisseurSelected.getId(), nom.getText(), prenom.getText(), email1.getText(), email2.getText(), tel1.getText(), tel2.getText(), tel3.getText(), adresse.getText(), nif.getText(), stat.getText(), null) ;
        ...
        refreshTable( fournisseurDAO.select() );  // Mettre à jour la table affichant les clients
    ...
    private void btndeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btndeleteActionPerformed
        ...
        if (confirm == JOptionPane.YES_OPTION) {
            if(fournisseurDAO.delete(fournisseurSelected))refreshTable( fournisseurDAO.select() );
        }
    ...
    private void btn_searchActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_searchActionPerformed
        try {
            refreshTable( fournisseurDAO.filter(client_key_search.getText()) );
  ...
  public void rowcount(){
    nombre_ligne.setText("Fournisseurs ("+ table.getRowCount()+")");
    }
  
    private void refreshTable( List < javaapp.bean.Personne > fournisseurs ){
