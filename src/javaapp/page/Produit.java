...
public class Produit extends javax.swing.JPanel {
    ...
    private void init(){
        ...
        refreshTable(DAOFactory.getProduitDAO().selectAll());
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, listPanelLayout.createSequentialGroup()
                ...
                .addGroup(listPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, listPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                        .addComponent(produitKeySearch, javax.swing.GroupLayout.PREFERRED_SIZE, 38, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addComponent(nombre_ligne)))
                .addGap(34, 34, 34)
                .addComponent(scrollTable, javax.swing.GroupLayout.PREFERRED_SIZE, 496, javax.swing.GroupLayout.PREFERRED_SIZE)
                ...
                .addGroup(panelBorderRound1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    ...
                    .addGroup(panelBorderRound1Layout.createSequentialGroup()
                        ...
                        .addGroup(panelBorderRound1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addComponent(longueur, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 38, javax.swing.GroupLayout.PREFERRED_SIZE))
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                        .addGroup(panelBorderRound1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                            .addGroup(panelBorderRound1Layout.createSequentialGroup()
                                .addComponent(jLabel18)
    ...
    private void tableMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tableMouseClicked
       listPanel.setVisible(false);
        ...
        produitSelected = DAOFactory.getProduitDAO().find(idSelected);
...
//                   UniteStockageDAO uniteStockDAO = DAOFactory.getUniteStockageDAO();
                   UniteStockage uniteStock= new UniteStockage();
                    ...
                    if(DAOFactory.getProduitDAO().create(produit)){
...
JOptionPane.showMessageDialog(null, "Création du produit effectuée!","Succès",JOptionPane.INFORMATION_MESSAGE);
               ...
               case "update":
                   if(JOptionPane.showConfirmDialog(null, "Voulez-vous sauvegarder vos modification?","Mise à jour",JOptionPane.YES_NO_OPTION) == 0){
                        ...
                        if(DAOFactory.getProduitDAO().update(produitSelected)){
...
//                            t.showtoast();
    ...
    private void btndeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btndeleteActionPerformed
        if(JOptionPane.showConfirmDialog(null, "Etes-vous sûr de vouloir supprimer ce produit?","Confirmation de suppression",JOptionPane.YES_NO_OPTION) == 0){
           if(DAOFactory.getProduitDAO().delete(produitSelected)){
    ...
    private void btn_searchActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_searchActionPerformed
        refreshTable(DAOFactory.getProduitDAO().filter(produitKeySearch.getText()));
