...
public class Compte1 extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        setPreferredSize(new java.awt.Dimension(1004, 1181));
        ...
        listPanelLayout.setVerticalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, listPanelLayout.createSequentialGroup()
                ...
                .addGroup(listPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(listPanelLayout.createSequentialGroup()
                        .addGap(303, 326, Short.MAX_VALUE)
                        .addComponent(filler1, javax.swing.GroupLayout.PREFERRED_SIZE, 25, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(261, 261, 261))
                    .addGroup(listPanelLayout.createSequentialGroup()
                        .addGap(12, 12, 12)
                        .addComponent(scrollTable, javax.swing.GroupLayout.PREFERRED_SIZE, 563, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGap(0, 0, Short.MAX_VALUE))
            .addComponent(listPanel, javax.swing.GroupLayout.DEFAULT_SIZE, 1071, Short.MAX_VALUE)
        );
        layout.setVerticalGroup(
            layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGroup(layout.createSequentialGroup()
                .addComponent(listPanel, javax.swing.GroupLayout.PREFERRED_SIZE, 757, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(0, 0, 0)
    ...
    private void tableMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tableMouseClicked
        ...
        setIdSelected(model.getValueAt(i, 0).toString()); // récupérer l'identifiant sélectionné
        profileSelected = profileDAO.find(Integer.parseInt(idSelected));
        if (profileSelected != null) {
            idProfile.setValue(profileSelected.getIdProfile());
         ...
         try {
            ...
            userSelected = userDAO.find(profileSelected.getIdUtilisateur());
        ...
        if (validatedForm()) {
            ...
            switch (btnSaveState) {
                case "insert":
                    ...
                    newUser.setPassword(new String(password1.getPassword()));
                    newUser.setIdGroupe( groupeDAO.find(nomGroupe.getSelectedItem().toString()).getIdGroupe() );
                    newUser.setDateCreation(now.format(dtFormat));
                    
                    if (userDAO.create(newUser)) {
                        Profile newProfile = new Profile();
                        newProfile.setNom(nom.getText());
                        newProfile.setPrenom(prenom.getText());
                        newProfile.setDateNaiss(dateFormat.format(date_naiss.getDate()));
                        newProfile.setFonction(fonction.getText());
                        newProfile.setTel(tel.getText());
                        newProfile.setAdresse(adresse.getText());
                        newProfile.setIdUtilisateur(userDAO.find(username.getText()).getIdUtilisateur());

                        if (profileDAO.create(newProfile)) {
...
//                        Profile existingProfile = profileDAO.find(Integer.parseInt(idSelected));
            ...
            JOptionPane.showMessageDialog(null, "Veuillez remplir correctement tous les champs", "Erreur", JOptionPane.INFORMATION_MESSAGE);
        }
    refreshTable(profileDAO.select());
    ...
    private void jLabel3MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel3MouseClicked
        if(JOptionPane.showConfirmDialog(null, "Etes-vous sûr de vouloir supprimer ce compte utilisateur?","Confirmation de suppression",JOptionPane.YES_NO_OPTION) == 0){
         Profile profile = profileDAO.find(Integer.parseInt(idSelected));
    ...
    public void rowcount(){
        nombre_ligne.setText("Comptes ("+ table.getRowCount()+")");
    }
